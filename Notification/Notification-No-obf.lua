...
function Library:Notify(options)
	...
	do
		...
		Notification["84"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
		...
		Notification["86"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
		...
		Notification["88"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
		...
		Notification["8a"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
...
function Library:ForceNotify(options)
	...
	do
		...
		Notification["88"]["TextSize"] = 25
		coroutine.wrap(function()
    local hue = 0
    while true do
         Notification["88"]["TextColor3"] = Color3.fromHSV(hue, 1, 1)
        hue = (hue + 0.015) % 1  
        task.wait(0.03)  
    end
end)()
		...
		Notification["8a"]["TextYAlignment"] = Enum.TextYAlignment.Top
		Notification["8a"]["BackgroundColor3"] = Color3.fromRGB(0, 0, 0)
		Notification["8a"]["TextSize"] = 17
	coroutine.wrap(function()
    local hue = 0
    while true do
         Notification["8a"]["TextColor3"] =Color3.fromHSV(hue, 1, 1)
        hue = (hue + 0.015) % 1  
        task.wait(0.03)  
    end
end)()
    ...
    local hue = 0
    while true do
        Notification["8b"]["BackgroundColor3"] = Color3.fromHSV(hue, 1, 1)
        hue = (hue + 0.015) % 1  
        task.wait(0.03)  
    end
end)()
    ...
    local hue = 0
    while true do
         Notification["8c"]["BackgroundColor3"] = Color3.fromHSV(hue, 1, 1)
        hue = (hue + 0.015) % 1  
        task.wait(0.03)  
    end
end)()
