...
local function FadeOutAndDestroy(ui)
    local UIScale = ui:FindFirstChildWhichIsA("UIScale")
    if UIScale then
        TweenService:Create(UIScale, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Scale = 0}):Play()
    end
    TweenService:Create(ui, TweenInfo.new(0.4), {BackgroundTransparency = 1}):Play()
    task.wait(0.4)
    ui:Destroy()
end
...
stroke.Enabled = true
TweenService:Create(stroke, TweenInfo.new(3, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {Transparency = 0.6}):Play()
...
TweenService:Create(UIGradient, TweenInfo.new(10, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut, -1), {Rotation = 360}):Play()

      TabMain.BackgroundTransparency = 1.000
      TabMain.Position = UDim2.new(0.217000037, 0, 0, 3)
      TabMain.Size = UDim2.new(0, 400, 0, 270)
      ...
      function window.Tab(window, name, icon)
        ...
        function section:Label(text)
          ...
          function section.Slider(section, text, flag, default, min, max, precise, callback)
            ...
            SliderPart.BackgroundColor3 = Color3.fromRGB(0, 255, 0)
